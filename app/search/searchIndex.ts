...
export const searchIndex: SearchItem[] = [
  ...
  {
    label: "Control center",
    description: "Control center · System logs",
    route: "/control-center/system-logs",
    keywords: ["system", "logs", "audit", "events", "monitoring", "errors", "warnings"],
  },
  {
    label: "Control center",
    description: "Control center · Material handling logs",
    route: "/control-center/material-handling-logs",
    keywords: ["material", "handling", "robots", "compartment", "transport", "logs"],
  },
  {
    label: "Configuration",
    description: "Configuration · Priorities",
    route: "/configuration/prioritization",
    keywords: ["priorities", "priority", "DHL", "Bring", "PostNord", "Express", "deadline", "finish time", "cutoff"],
  },
  {
    label: "Configuration",
    description: "Configuration · Strategies",
    route: "/configuration/strategies",
    keywords: ["strategies", "picking", "putaway", "inventory", "replenishment", "wave picking", "slotting"],
  },
  {
    label: "Configuration",
    description: "Configuration · Bins",
    route: "/configuration/bins",
    keywords: ["bins", "compartments", "capacity", "fill level", "zone", "occupied", "available"],
  },
  {
    label: "Configuration",
    description: "Configuration · Inventory rules",
    route: "/configuration/inventory-rules",
    keywords: ["inventory rules", "reorder", "expiration", "allocation", "cycle count", "threshold", "actions"],
  },
  {
    label: "Configuration",
    description: "Configuration · User management",
    route: "/configuration/user-management",
    keywords: ["users", "groups", "roles", "MFA", "administrator", "warehouse worker", "Thomas", "Susan"],
  },
  {
    label: "Configuration",
    description: "Configuration · System settings",
    route: "/configuration/system-settings",
    keywords: ["settings", "robot configuration", "order processing", "notifications", "performance"],
  },
  {
    label: "Configuration",
